                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!fs_extra_1.default.existsSync(this.source))
                            return [2 /*return*/, utils_1.log("source不存在")];
                        if (!path_1.default.isAbsolute(this.source) || !path_1.default.isAbsolute(this.target))
                            return [2 /*return*/, utils_1.log("source或者target必须是绝对路径")];
                        if (this.source === this.target)
                            return [2 /*return*/, utils_1.log("source 和 target 不能相同")];
                    ...
                    case 2:
                        ...
                        if (sourcePathIsFile !== targetPathIsFile)
                            return [2 /*return*/, utils_1.log("路径类型需要一致")];
                        if (sourcePathIsFile && targetPathIsFile) {
                            if (path_1.default.extname(this.source) !== path_1.default.extname(this.target))
                                return [2 /*return*/, utils_1.log("文件类型需要一致")];
                        }
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, utils_1.copyFiles(path_1.default.resolve(sourceDir_1, dirPath), path_1.default.resolve(targetDir_1, dirPath))];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
