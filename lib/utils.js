...
exports.log = exports.rimrafPromify = exports.copyFiles = exports.pathIsFile = exports.isPathExists = exports.to = void 0;
 ...
 * @returns {boolean}
 */
exports.isPathExists = function (pathStr) {
    return fs_extra_1.default.existsSync(pathStr);
};
/**  判断一个路径是目录还是文件
...
exports.pathIsFile = function (pathStr) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!exports.isPathExists(pathStr)) return [3 /*break*/, 2];
